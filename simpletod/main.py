...
from simpletod_utils.model import *
from simpletod_utils.language_model import get_optimizer_scheduler
from simpletod_utils.gpt2_args_parser import ArgsParser
...
def get_model_tokenizer(args):
    ...
    if args.block_size <= 0:
        # args.block_size = tokenizer.max_len # default of GPT2 is 1024
        args.block_size = 128
...
def train(args, train_dataset, model, tokenizer):
    ...
    for _ in train_iterator:
        ...
        model, optimizer, scheduler, global_step, tr_loss, logging_loss, best_dev_perp = train_epoch(model, tokenizer, optimizer, scheduler, train_dataloader, tr_loss, logging_loss, global_step,
                                  steps_trained_in_current_epoch, tb_writer, best_dev_perp, args)
...
def main():
    ...
    # TODO(syavuz): figure out how to pass this flag
    args.save_total_limit = 20
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        checkpoints = [os.path.join(args.output_dir, "best_dev_checkpoint")]
